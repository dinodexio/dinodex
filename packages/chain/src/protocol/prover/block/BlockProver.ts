import {
  ...
  import {
    ...
    PlainZkProgram,
    provableMethod,
    type WithZkProgrammable,
    ZkProgrammable,
  } from "@proto-kit/common";
  
//   import { DefaultProvableHashList } from "../../utils/ProvableHashList";
  import { DefaultProvableHashList, MethodPublicOutput, ProtocolModule,
    ...
    NetworkState,
    SignedTransaction,
    MinaActions, MinaActionsHashList,
    StateTransitionReductionList,
    BlockProvable,
    BlockProverExecutionData,
    type BlockProverProof,
  ...
  > {
    ...
    >[] {
      ...
      const StateTransitionProofClass = stateTransitionProver.zkProgramFactory()[0].Proof;
