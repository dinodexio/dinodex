...
import { type Mempool } from "@proto-kit/sequencer";
import {
  sequencerModule,
  SequencerModule,
...
import { 
    type BlockQueue, 
    PendingTransaction, 
    type AsyncMerkleTreeStore, 
    type AsyncStateService,  Block, BlockWithResult, 
    CachedStateService, type MessageStorage,
...
export class BlockProducerModule extends SequencerModule<BlockConfig> {
  ...
  public async getLatestBlock(){
    return await this.blockQueue.getLatestBlock();
  }
