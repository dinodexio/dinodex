...
import { RollupMerkleTree } from "../../../protocol/settlement/contracts/src/common/ProtokitCommon.js";
import { log } from "../../../protocol/settlement/contracts/src/common/log.js";
...
import {type BlockProducerModule} from "../../protocol/production/sequencing/BlockProducerModule.js"
import {SettlementModule} from "../../settlement/SettlementModule.js";
import { BlockProofSerializer } from "@proto-kit/sequencer/dist/protocol/production/helpers/BlockProofSerializer.js";
import { Balance } from "../integration/mocks/Balance.js";
import { Withdrawals } from "../integration/mocks/Withdrawals.js";
import { testingSequencerFromModules } from "../TestingSequencer.js";
import { createTransaction } from "../integration/utils.js";
import { MinaBlockchainAccounts } from "../../protocol/baselayer/accounts/MinaBlockchainAccounts.js";
import { FeeStrategy } from "../../protocol/baselayer/fees/FeeStrategy.js";
...
export const settlementTestFn = (
  ...
  // eslint-disable-next-line no-lone-blocks
  {
    ...
    let blockQueue: BlockProducerModule;
    ...
    beforeAll(async () => {
      ...
      blockQueue = appChain.sequencer.resolve("BlockProducerModule") as BlockProducerModule;
      ...
      async () => {
        ...
        const tx = await Mina.transaction(
          ...
          async () => {
            ...
            await dispatch.deposit(UInt64.from(100), Field(0));
          }
        );
    ...
    it(
      ...
      async () => {
        ...
        if (baseLayerConfig.network.local !== true) {
          await fetchAccount({
