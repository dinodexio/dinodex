  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="flex flex-col w-full px-[16px] pt-8 xl:px-[41px] lg:px-[32px] sm:px-[16px] pb-[8px]">
        <Header />
        <div className="mt-[63px] max-w-[1146px] w-[95%] mx-auto flex flex-col gap-[30px]">
          ...
          <div className="flex items-center justify-between w-full xl:hidden lg:hidden sm:flex">
            <div className="stats-card">
              <span className="stats-title">DinoDEX TVL</span>
              <span className="stats-value">$3.22B</span>
            </div>
            <div className="stats-card">
              <span className="stats-title">DinoDEX TVL</span>
              <span className="stats-value">$3.22B</span>
              <span className="stats-subtext">Past month</span>
            </div>
          </div>
