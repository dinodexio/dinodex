...
const handleClickShowSwap = () => {
    let swapLayoutViewPool = document.querySelector('.swap-layout')
    let btnSwapViewPool = document.querySelector('.btn-swap-view-pool')
    if (swapLayoutViewPool.classList.contains('hide-swap-layout')) {
        swapLayoutViewPool.classList.remove('hide-swap-layout')
        btnSwapViewPool.innerHTML = `<span class="view-pool-left-header-item-text"><strong>x</strong> Close</span>`
        btnSwapViewPool.classList.add('btn-swap-view-pool-close')
    } else {
        swapLayoutViewPool.classList.add('hide-swap-layout')
        btnSwapViewPool.classList.remove('btn-swap-view-pool-close')
        btnSwapViewPool.innerHTML = `<span class="view-pool-left-header-item-text">Swap</span>`
    }
}
